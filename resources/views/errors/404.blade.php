...
<div class="flex-center position-ref full-height">
    <div class="content">
        ...
        <div class="flex-center">
            <i class="fa fa-quote-left fa-1 fa-pull-left" style="margin-bottom: 33px;"></i><h1>Lo He Intentado! :(</h1>
            <i class="fa fa-quote-right fa-1 fa-pull-right" style="margin-bottom: 33px;"></i>
        </div>
        <div class="flex-center">
            <h2>El Sitio que has solicitado no se ha encontrado! (ERROR: 404_not_found)</h2>
        </div>
        <div class="btn"><a href="{{url('/') }}"><h1>Volver?</h1></a></div>
